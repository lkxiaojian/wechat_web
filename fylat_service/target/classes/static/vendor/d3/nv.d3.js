...
// candlestickChart is just a historical chart with candlestick bars and some tweaks
    ...
    nv.models.multiChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                interactiveLayer.dispatch.on('elementMousemove', function(e) {
                    ...
                    stack1.clearHighlights();
                    /*stack2.clearHighlights();*/
                    /*bars1.clearHighlights();
                     bars2.clearHighlights();*/
                    var singlePoint, pointIndex, pointXLocation, allData = [];
                    data
                        .filter(function(series, i) {
                            series.seriesIndex = i;
                        ...
                        .forEach(function(series,i) {
                            ...
                            if (pointYValue != null) {
                                ...
                                stack1.highlightPoint(i, pointIndex, true);
                                /*stack2.highlightPoint(i, pointIndex, true);*/
                                /*bars1.highlightPoint(i, pointIndex, true);
                                 bars2.highlightPoint(i, pointIndex, true);*/
                            }
                            if (point === undefined) return;
                            if (singlePoint === undefined) singlePoint = point;
                            if (pointXLocation === undefined) pointXLocation = chart.xScale()(chart.x()(point,pointIndex));
                            allData.push({
                                key: series.key,
                                value: {v:pointYValue,t:series.yAxis},
                                color: color(series,series.seriesIndex)
                            });
                        });
                    //Highlight the tooltip entry based on which point the mouse is closest to.
                    ...
                    interactiveLayer.tooltip
                        ...
                        .chartContainer(that.parentNode)
                        .valueFormatter(function(d,i) {
                            var axis= (d.t==1)?yAxis1:yAxis2;
                            return d == null ? "N/A" : axis.tickFormat()(d.v);
                        })
                        .data({
                            value: xValue,
                            index: pointIndex,
                ...
                interactiveLayer.dispatch.on('elementClick', function(e) {
                    ...
                    lines1.dispatch.elementClick(allData);
                });
        ...
        nv.utils.inheritOptions(chart, lines1);
        nv.utils.inheritOptions(chart, lines2);
        nv.utils.inheritOptions(chart, stack1);
         /*nv.utils.inheritOptions(chart, stack2);*/
        /*nv.utils.inheritOptions(chart, bars1);
         nv.utils.inheritOptions(chart, bars2);*/
        nv.utils.initOptions(chart);
