...
public class UserDaoIml implements userDao {
    ...
    public Map<String, Object> getIndexMessage(String wechatid, int page) {
        ...
        if (count > 0 && pageSize * page <= count || count < 10) {
            ...
            String sqld = "SELECT COUNT(*)-1 AS num_prods,c.article_type_id,c.article_id,c.article_keyword,c.create_time,c.content_excerpt,c.article_title,DATE_ADD(c.update_time,INTERVAL -8 hour) as update_time,d.iamge_icon,d.article_type_name " +
...
//                    ") AND a.wechat_id=? GROUP BY d.article_type_id ORDER BY c.create_time DESC LIMIT ?,?";
            ...
            String isNoLoveSql = "SELECT COUNT(*)-1 AS num_prods,c.article_id,c.article_type_id,c.article_keyword,c.create_time,c.content_excerpt,c.article_title,DATE_ADD(c.update_time,INTERVAL -8 hour) as update_time,d.iamge_icon,d.article_type_name FROM \n" +
